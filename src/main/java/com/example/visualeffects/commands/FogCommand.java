    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("fog")
                ...
                .then(CommandManager.literal("set")
                        .then(CommandManager.argument("strength", DoubleArgumentType.doubleArg(0.0, 1.0))
                                .then(CommandManager.argument("density", DoubleArgumentType.doubleArg(0.0, 1.0))
                                        .then(CommandManager.argument("radius", DoubleArgumentType.doubleArg(1.0, 100.0))
                                                .then(CommandManager.argument("isSphereShape", BoolArgumentType.bool())
                                                        .then(CommandManager.argument("renderDistance", DoubleArgumentType.doubleArg(1.0, 256.0))
                                                                .then(CommandManager.argument("affectedByLight", BoolArgumentType.bool())
                                                                        .then(CommandManager.argument("swirlingStrength", DoubleArgumentType.doubleArg(0.0, 1.0))
                                                                                .then(CommandManager.argument("layeringStrength", DoubleArgumentType.doubleArg(0.0, 1.0))
