...
public class SnowCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(literal("snow")
                        .then(literal("set")
                                .then(argument("minSize", DoubleArgumentType.doubleArg(0.01, 1.0))
                                        .then(argument("maxSize", DoubleArgumentType.doubleArg(0.01, 1.0))
                                                .then(argument("count", IntegerArgumentType.integer(1, 10000))
                                                        .then(argument("radius", DoubleArgumentType.doubleArg(1.0, 100.0))
                                                                .then(argument("spinSpeed", DoubleArgumentType.doubleArg(0.0, 10.0))
                                                                        .then(argument("fallSpeed", DoubleArgumentType.doubleArg(0.1, 10.0))
                                                                                .then(argument("angleVariance", DoubleArgumentType.doubleArg(0.0, 180.0))
                                                                                        .then(argument("shimmyStrength", DoubleArgumentType.doubleArg(0.0, 1.0))
