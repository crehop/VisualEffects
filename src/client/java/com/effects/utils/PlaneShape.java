...
public class PlaneShape extends Shape {
    ...
    public PlaneShape(BlockPos position, Identifier texture, int rows, int columns, int totalFrames, int animationSpeed,
                      float width, float height, boolean faceCamera) {
